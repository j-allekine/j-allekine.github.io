...
- **Homepage navigation:** Use homepage section anchors in the fixed desktop sidebar and the tablet/mobile navigation drawer. Show Home, Work, Stack, and Contact. Do not include Process or About in navigation; the sections remain in the homepage flow. The Services section remains removed.
